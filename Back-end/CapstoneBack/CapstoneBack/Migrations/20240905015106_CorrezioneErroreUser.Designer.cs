...
namespace CapstoneBack.Migrations
{
    ...
    [Migration("20240905015106_CorrezioneErroreUser")]
    partial class CorrezioneErroreUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CapstoneBack.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            PasswordHash = "$2a$11$3wSMhv27P4k/A57/adYaiucmpS.jRaA.MkeLsfP8vyi0AES1Fg1wC",
                            RoleId = 3,
                            UserName = "SuperAdmin"
                        });
                });
