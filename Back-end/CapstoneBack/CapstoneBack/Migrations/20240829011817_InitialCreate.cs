...
namespace CapstoneBack.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "LoyaltyCardTypes",
                columns: table => new
                {
                    LoyaltyCardTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoyaltyCardTypes", x => x.LoyaltyCardTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserBookStatuses_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                name: "UserLoyaltyCards",
                columns: table => new
                {
                    UserLoyaltyCardId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    LoyaltyCardTypeId = table.Column<int>(type: "int", nullable: false),
                    TotalSpent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CardAssignedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLoyaltyCards", x => x.UserLoyaltyCardId);
                    table.ForeignKey(
                        name: "FK_UserLoyaltyCards_LoyaltyCardTypes_LoyaltyCardTypeId",
                        column: x => x.LoyaltyCardTypeId,
                        principalTable: "LoyaltyCardTypes",
                        principalColumn: "LoyaltyCardTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLoyaltyCards_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookStatuses_StatusId",
                table: "UserBookStatuses",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLoyaltyCards_LoyaltyCardTypeId",
                table: "UserLoyaltyCards",
                column: "LoyaltyCardTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLoyaltyCards_UserId",
                table: "UserLoyaltyCards",
                column: "UserId");
