...
namespace CapstoneBack.Migrations
{
    ...
    [Migration("20240904205657_ModificheAiCampiUserBook")]
    partial class ModificheAiCampiUserBook
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CapstoneBack.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            PasswordHash = "$2a$11$TM3ZvRJIuAaKsMt/l/m7JeJ7LMs0H.h5my/3oe3BF0YNWjnbDb8m.",
                            RoleId = 3,
                            UserName = "SuperAdmin"
                        });
                });
