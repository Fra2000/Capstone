...
namespace CapstoneBack.Migrations
{
    ...
    [Migration("20240904163249_Add-Migration AggiuntaQuantitaLibri")]
    partial class AddMigrationAggiuntaQuantitaLibri
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CapstoneBack.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Admin",
                            PasswordHash = "$2a$11$jLFeG3Tc60QXNsNgftBbcuJifq3Q46zkS11OscdEaEuECbyLm9IkK",
                            RoleId = 3,
                            UserName = "SuperAdmin"
                        });
                });
