...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CapstoneBack API", Version = "v1" });

    // Configura JWT nell'interfaccia Swagger
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "CapstoneBack API v1");
